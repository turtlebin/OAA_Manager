 ...
 * viewer component. A file specified at the command line is opened in a JFrame
 * which contains the viewer component.
 *
 * @since 2.0
 */
public class ViewerComponentExample {
	public static void main(String[] args) {
		...
		final String filePath = "C:/Users/Administrator/Desktop/课题《大数据管理平台》产品设计文档—许诺.pdf";
