...
public class Document {
	...
	/**
	 * Adds an author to this <tt>Document</tt>. If the given string is null, no
	 * author will be added. Returns the receiver for convenience.
	 */
	...
	/**
	 * Removes all author fields if any exist. Returns the receiver for
	 * convenience.
	 */
	...
	/**
	 * Returns the <i>first</i> author field that was added, or null, if none
	 * has been set.
	 */
	...
	/**
	 * Returns the title of this <tt>Document</tt>, or null if none has been
	 * set.
	 */
	...
	/**
	 * Sets the title of the <tt>Document</tt>. If the title is null, the title
	 * will be set to an empty string. Returns the receiver for convenience.
	 */
	...
	/**
	 * Sets the contents of the <tt>Document</tt>. If the given StringBuffer is
	 * null, the contents field will be set to an empty string. Returns the
	 * receiver for convenience.
	 */
	public Document setContents(StringBuffer contents) {
		// Don't remove the content field here, because it's used for the
		// filename
	...
	/**
	 * Sets the contents of this <tt>Document</tt>. If the given String is null,
	 * the contents field will be set to an empty string. Returns the receiver
	 * for convenience.
	 */
