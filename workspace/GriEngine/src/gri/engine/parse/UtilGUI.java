...
public class UtilGUI {
	...
	/**
	 * Places <tt>shell</tt> at the center of the shell <tt>parent</tt>, or in
	 * the middle of the screen if <tt>parent</tt> is null. Note that the shell
	 * size must have already been set in order to get a correct result.
	 */
	...
	public static void showErrorMsg(String message) {
		showMsg("system_error", message, SWT.ICON_ERROR | SWT.OK | SWT.PRIMARY_MODAL);
	}
	...
	public static int showConfirmMsg(String message) {
		return showMsg("confirm_operation", message, SWT.ICON_QUESTION | SWT.OK | SWT.CANCEL | SWT.PRIMARY_MODAL);
	}
	...
	public static void showWarningMsg(String message) {
		showMsg("invalid_operation", message, SWT.ICON_WARNING | SWT.OK | SWT.PRIMARY_MODAL);
	}
	...
	/**
	 * Is the KeyEvent a carriage return ? It can be the normal one or from the
	 * keypad
	 */
