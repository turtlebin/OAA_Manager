...
public class DBDao2 {
    ...
    public DBDao2(List<DataSourceNeededColumn> list)
    {
    ...
    public List<DataSource> getDataSources2() throws SQLException
    {
...
//    	}
    	...
    	for(DataSourceNeededColumn neededInit:neededList)
    	{
    		select[i]=new ConcurrentSelect(neededInit,barrier,"2");
    		select[i].start();
    		i++;
    	}
    	try {
