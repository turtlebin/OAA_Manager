 ...
 * Created by weiwenjie on 2017-3-24
 */
public class Paragraph extends GriElement implements Serializable{
	...
	public Paragraph(String name){ super(name);}
	
	public Paragraph(String name, String keywords, String description, String syncTimeType, String syncDirectionType,
